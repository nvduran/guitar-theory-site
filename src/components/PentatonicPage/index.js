...
export default function PentatonicPage() {
        ...
        const handleNewFeatureRedirect = () => {
                window.location.href = "/FullFretboard";
        };
                ...
                <div>
                        <div className="settings-and-key-div">
                                ...
                                <div className="advanced-settings-button-div">
                                        <Button className="advanced-settings-button" variant="outline-secondary" size="sm" onClick={handleShowModal}>
                                                Options
                                        </Button>
                                </div>
                        </div>
                                ...
                                <Modal.Body>
                                        <div className="frets-selection-in-modal">
                                                ...
                                                <div className="button-group-frets-in-modal">
                                                        <ButtonGroup>
                                                                <ToggleButton
                                                                        variant={advancedSettings.frets === 4 ? "secondary" : "outline-secondary"}
                                                                        onClick={() => {
                                                                ...
                                                                <ToggleButton
                                                                        variant={advancedSettings.frets === 6 ? "secondary" : "outline-secondary"}
                        ...
                        <div>
                                {Array.from(Array(fretboardCount).keys()).map((i) => (
                                        <div key={i}>
                                                <div>
                                                        <FretboardView advancedSettings={advancedSettings} setAdvancedSettings={setAdvancedSettings} key={advancedSettings.frets} />
                                                </div>
                                        </div>
                                ))}
                                ...
                                {fretboardCount > 1 && (
                                        <button className="remove-fretboard-button" onClick={handleRemoveFretboard}>
                                                -
                                        </button>
                                )}
                        </div>
                        <div className="new-feature-banner-container">
                                <div className="new-feature-banner" onClick={handleNewFeatureRedirect}>
                                        Try out our NEW Full Fretboard view!
                                </div>
                        </div>
                </div>
        );
